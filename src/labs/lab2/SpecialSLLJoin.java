...
public class SpecialSLLJoin<E> {
    ...
    public SLL<E> specialJoin(SLL<E> list1, SLL<E> list2) {
        SLLNode<E> first = list1.getFirst();
        SLLNode<E> second = list2.getFirst();
        ...
        while(first != null || second != null){
            ...
            if(br % 2 == 0 && second != null){
                if (second.succ != null) {
                    newList.insertLast(second.element);
                    second = second.succ;
                    newList.insertLast(second.element);
                } else{
                    newList.insertLast(second.element);
                ...
                second = second.succ;
            } else if(br % 2 != 0 && first != null){
                if (first.succ != null) {
                    newList.insertLast(first.element);
                    first = first.succ;
                    newList.insertLast(first.element);
                } else{
                    newList.insertLast(first.element);
