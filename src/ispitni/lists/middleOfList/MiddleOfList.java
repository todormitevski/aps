//package ispitni.lists.middleOfList;
//
...
//        System.out.printf("Middle of list: %s\n", findMiddle(list,true));
//        System.out.printf("List starting from middle: %s\n", findMiddle(list,false));
//    }
//
//    private static Object findMiddle(SLL<Integer> list, boolean justMiddleElem) {
